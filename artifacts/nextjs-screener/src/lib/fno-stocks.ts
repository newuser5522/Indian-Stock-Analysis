// NSE F&O eligible stocks (Equity Derivatives segment)
export const FNO_SYMBOLS = new Set([
  ...
  "DELTACORP.NS","DIVISLAB.NS","DIXON.NS","DLF.NS","DRREDDY.NS","EICHERMOT.NS",
  ...
  "HINDPETRO.NS","HINDUNILVR.NS","HONAUT.NS","IBULHSGFIN.NS","ICICIGI.NS",
  "ICICIBANK.NS","ICICILOMBARD.NS","ICICIPRULI.NS","IDFCFIRSTB.NS","IEX.NS",
  "IPCALAB.NS","INDIGO.NS","INDUSINDBK.NS","INDUSTOWER.NS","INFY.NS",
  "IOC.NS","IPCALAB.NS","IRCTC.NS","ITC.NS","JINDALSTEL.NS","JKCEMENT.NS",
  "JSL.NS","JSWENERGY.NS","JSWSTEEL.NS","JUBLFOOD.NS","KOTAKBANK.NS",
  "L&TFH.NS","LALPATHLAB.NS","LAURUSLABS.NS","LICHSGFIN.NS","LT.NS",
  "LTTS.NS","LUPIN.NS","M&M.NS","M&MFIN.NS","MANAPPURAM.NS","MARICO.NS",
  "MARUTI.NS","MCDOWELL-N.NS","MCX.NS","METROPOLIS.NS","MFSL.NS","MINFY.NS",
  "MOTHERSON.NS","MPHASIS.NS","MRF.NS","MUTHOOTFIN.NS","NATIONALUM.NS",
  "NAUKRI.NS","NAVINFLUOR.NS","NESTLEIND.NS","NMDC.NS","NTPC.NS",
  "OBEROIRLTY.NS","OFSS.NS","ONGC.NS","PAGEIND.NS","PEL.NS","PERSISTENT.NS",
  ...
  "SHRIRAMFIN.NS","SIEMENS.NS","SRF.NS","SUNPHARMA.NS","SUNTV.NS",
  "SUPREMEIND.NS","SYNGENE.NS","TATACONSUM.NS","TATAMOTORS.NS","TATAPOWER.NS",
  ...
  "VOLTAS.NS","WIPRO.NS","ZEEL.NS","ZOMATO.NS","ZYDUSLIFE.NS","IRFC.NS",
  "HDFCBANK.NS","CAMS.NS","DMART.NS","POLICYBZR.NS","NYKAA.NS","PAYTM.NS",
]);

export function isFno(symbol: string): boolean {
  return FNO_SYMBOLS.has(symbol);
}
